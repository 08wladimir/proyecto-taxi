...
class CouponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post coupons_url, params: { coupon: { datefinish: @coupon.datefinish, datestart: @coupon.datestart, name: @coupon.name, quantity: @coupon.quantity, state: @coupon.state } }
    end
  ...
  test "should update coupon" do
    patch coupon_url(@coupon), params: { coupon: { datefinish: @coupon.datefinish, datestart: @coupon.datestart, name: @coupon.name, quantity: @coupon.quantity, state: @coupon.state } }
